...
You can verify that all needed files are there, by listing the files in the `./copasi-dependencies/bin/lib` directory. You ought to see: 
...
after which the `copasi-dependencies/bin/lib` directory contains the files: 
	...
	bash-4.2# ls copasi-dependencies/bin/lib
