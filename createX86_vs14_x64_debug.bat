...
if "%INCLUDE%"=="" call  "%ProgramFiles(x86)%\Microsoft Visual Studio 14.0\VC\vcvarsall.bat" x86_amd64
...
SET TEMP_DIR=tmp_vs14_x64_%BUILD_TYPE%%STATIC%
SET BIN_DIR=bin_vs14_x64_%BUILD_TYPE%%STATIC%
