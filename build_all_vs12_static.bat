...
move bin bin_vs12_static_x86_debug
move tmp tmp_vs12_static_x86_debug

title Building x86 release
cd /d %THIS_DIR%
call createX86_vs12_x86_release 
move bin bin_vs12_static_x86_release
move tmp tmp_vs12_static_x86_release
...
move bin bin_vs12_static_x64_debug
move tmp tmp_vs12_static_x64_debug

title Building x64 release
cd /d %THIS_DIR%
call createX86_vs12_x64_release 
move bin bin_vs12_static_x64_release
move tmp tmp_vs12_static_x64_release
