...
AppVerName=MATLAB Interface of libSBML 5.5.0
AppPublisher=SBML Team
AppPublisherURL=http://sbml.org
AppSupportURL=http://sbml.org
AppUpdatesURL=http://sbml.org
DefaultDirName={pf}\SBML\libSBML-5.5.0-libxml2-x64\bindings\matlab
DefaultGroupName=libSBML-matlab
DisableProgramGroupPage=yes
OutputDir=.\Output
OutputBaseFilename=libSBML-5.5.0-win-matlab-x64
...
Root: HKLM; Subkey: Software\SBML\libSBML\MATLAB; ValueType: string; ValueName: Version; ValueData: 5.5.0
...
**********************************************************************************************************}
  MsgBox('This setup installs the Windows version of the MATLAB binding of libSBML 5.5.0 built using the libxml2 2.7.3 XML Parser library. All the necessary libraries are included. The source code is available as a separate download.', mbInformation, mb_Ok);
 end;
