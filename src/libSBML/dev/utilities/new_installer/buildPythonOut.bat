...
SET PYTHON_26_32=c:\Python26\python.exe
SET PYTHON_26_64=\python.exe
SET PYTHON_27_32=c:\Python27\python.exe
SET PYTHON_27_64=\python.exe
...
SET INSTALL_DIR_32=D:\Development\libsbml_32_inst
SET INSTALL_DIR_64=D:\Development\libsbml_32_inst

SET DEP_DIR_32=D:\Development\libsbml_dependencies\dist\libSBML_Dependencies-1.0.0-b1-win32
SET DEP_DIR_64=
...
REM copy "%SOURCE_32%\libsbml\__init__.py" "%SOURCE_32%\build\lib.win-amd64-2.5\libsbml"
