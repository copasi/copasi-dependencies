; Version No is currently 5.5.0
; Check before use


[Setup]
AppName=libSBML
AppVerName=libSBML 5.5.0
AppPublisher=SBML Team
AppPublisherURL=http://sbml.org
AppSupportURL=http://sbml.org
AppUpdatesURL=http://sbml.org
DefaultDirName={pf}\SBML\libSBML-5.5.0-libxml2-x86
DefaultGroupName=libSBML
DisableProgramGroupPage=yes
OutputDir=.\Output
OutputBaseFilename=libSBML-5.5.0-win-x86
...
Source: D:\Development\libsbml\dev\utilities\new_installer\libsbml\bindings\octave\*; DestDir: {code:GetOctaveDir}; Flags: ignoreversion recursesubdirs createallsubdirs; Check: GetOctave
Source: D:\Development\libsbml\dev\utilities\new_installer\libsbml\win32\bin\libsbml.dll; DestDir: {code:GetOctaveDir}; Flags: ignoreversion recursesubdirs createallsubdirs; Check: GetOctave
...
Root: HKLM; Subkey: Software\SBML\libSBML; ValueType: string; ValueName: Version; ValueData: 5.5.0
...
**********************************************************************************************************}
  MsgBox('This setup installs the Windows version of libSBML 5.5.0 built using the libxml2 2.7.3 XML Parser library. All the necessary libraries are included. The source code is available as a separate download.', mbInformation, mb_Ok);
end;
...
Filename: "{app}\bindings\python\libSBML-5.5.0-win-py2.5-x86.exe"; Check: GetPython25;
Filename: "{app}\bindings\python\libSBML-5.5.0-win-py2.6-x86.exe"; Check: GetPython26;
Filename: "{app}\bindings\python\libSBML-5.5.0-win-py2.7-x86.exe"; Check: GetPython27;
Filename: "{app}\bindings\matlab\libSBML-5.5.0-win-matlab-x86.exe"; Check: GetMatlab;
