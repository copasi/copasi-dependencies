...
DefaultDirName={pf}\SBML\libSBML-5.5.0-libxml2-x64
DefaultGroupName=libSBML
DisableProgramGroupPage=yes
OutputDir=.\Output
OutputBaseFilename=libSBML-5.5.0-win-x64
...
Filename: "{app}\bindings\python\libSBML-5.5.0-win-py2.6-amd64.exe"; Check: GetPython26;
Filename: "{app}\bindings\python\libSBML-5.5.0-win-py2.7-amd64.exe"; Check: GetPython27;
Filename: "{app}\bindings\matlab\libSBML-5.5.0-win-matlab-x64.exe"; Check: GetMatlab;
