 ...
 *
 * $Id: Member.h 13541 2011-04-08 22:16:45Z fbergmann $
 * $HeadURL: https://sbml.svn.sourceforge.net/svnroot/sbml/branches/libsbml-5/src/sbml/packages/groups/sbml/Member.h $
 *
 * <!--------------------------------------------------------------------------
...
public:
  ...
  /**
   * @return a (deep) copy of this Member.
   */
...
public:
  ...
  /**
   * @return a (deep) copy of this ListOfMembers.
   */
