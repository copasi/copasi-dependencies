...
/** */ /* libsbml-internal */ public new
 void updateSBMLNamespace(string package, long level, long version) {
  ...
  public SBaseList getListOfAllElements(ElementFilter filter) {
    SBaseList ret = new SBaseList(libsbmlPINVOKE.SBasePlugin_getListOfAllElements__SWIG_0(swigCPtr, ElementFilter.getCPtr(filter)), true);
    return ret;
  }

  public SBaseList getListOfAllElements() {
    SBaseList ret = new SBaseList(libsbmlPINVOKE.SBasePlugin_getListOfAllElements__SWIG_1(swigCPtr), true);
    return ret;
  }
