...
/**
 ...
 void read(XMLNode node, int flag) {
    libsbmlPINVOKE.SBase_read__SWIG_0(swigCPtr, XMLNode.getCPtr(node), flag);
...
/**
 ...
 void read(XMLNode node) {
    libsbmlPINVOKE.SBase_read__SWIG_1(swigCPtr, XMLNode.getCPtr(node));
    if (libsbmlPINVOKE.SWIGPendingException.Pending) throw libsbmlPINVOKE.SWIGPendingException.Retrieve();
  }
...
/** */ /* libsbml-internal */ public
 void read(XMLInputStream stream) {
    libsbmlPINVOKE.SBase_read__SWIG_2(swigCPtr, XMLInputStream.getCPtr(stream));
    if (libsbmlPINVOKE.SWIGPendingException.Pending) throw libsbmlPINVOKE.SWIGPendingException.Retrieve();
  }
...
/** */ /* libsbml-internal */ public new
 void write(XMLOutputStream stream) {
    libsbmlPINVOKE.SBase_write(swigCPtr, XMLOutputStream.getCPtr(stream));
    if (libsbmlPINVOKE.SWIGPendingException.Pending) throw libsbmlPINVOKE.SWIGPendingException.Retrieve();
  }
...
/** */ /* libsbml-internal */ public
 int checkCompatibility(SBase object_) {
    int ret = libsbmlPINVOKE.SBase_checkCompatibility(swigCPtr, SBase.getCPtr(object_));
    return ret;
  }
...
/** */ /* libsbml-internal */ public
 void removeDuplicateAnnotations() {
    libsbmlPINVOKE.SBase_removeDuplicateAnnotations(swigCPtr);
  }
...
/** */ /* libsbml-internal */ public new
 void updateSBMLNamespace(string package, long level, long version) {
  ...
  public SBaseList getListOfAllElements(ElementFilter filter) {
    SBaseList ret = new SBaseList(libsbmlPINVOKE.SBase_getListOfAllElements__SWIG_0(swigCPtr, ElementFilter.getCPtr(filter)), true);
    return ret;
  }

  public SBaseList getListOfAllElements() {
    SBaseList ret = new SBaseList(libsbmlPINVOKE.SBase_getListOfAllElements__SWIG_1(swigCPtr), true);
    return ret;
  }

  public SBaseList getListOfAllElementsFromPlugins(ElementFilter filter) {
    SBaseList ret = new SBaseList(libsbmlPINVOKE.SBase_getListOfAllElementsFromPlugins__SWIG_0(swigCPtr, ElementFilter.getCPtr(filter)), true);
    return ret;
  }

  public SBaseList getListOfAllElementsFromPlugins() {
    SBaseList ret = new SBaseList(libsbmlPINVOKE.SBase_getListOfAllElementsFromPlugins__SWIG_1(swigCPtr), true);
    return ret;
  }
