...
#include "outputsbml_package_declarations.h"
...
mexFunction (int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
  ...
  SBMLNamespaces_t *ns;
	...
	#include "outputsbml_package_mex_declarations.h"
...
/**
  ...
  #include "outputsbml_package_detections.h"
...
#include "outputsbml_package_model.h"
			        ...
			        Model_t * sbmlModel)
{
 ...
 #include "outputsbml_package_getspecies_declarations.h" 
  ...
  SBasePlugin_t *plugin;
		...
		if (unSBMLLevel < 3)
    {
      ...
      /* getConversionFactor */
		  ...
		  #include "outputsbml_package_getspecies_implementations.h"
    ...
    /* free any memory allocated */
	  ...
	  #include "outputsbml_package_getspecies_cleanup.h"
...
#include "outputsbml_package_implementations.h"
