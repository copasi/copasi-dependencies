...
/**
 ...
 Rule removeRuleByVariable(String variable) {
  return (Rule) libsbml.DowncastSBase(libsbmlJNI.Model_removeRuleByVariable(swigCPtr, this, variable), true);
}
...
/** * @internal */ public
 void updateSBMLNamespace(String _package, long level, long version) {
    libsbmlJNI.Model_updateSBMLNamespace(swigCPtr, this, _package, level, version);
  }
