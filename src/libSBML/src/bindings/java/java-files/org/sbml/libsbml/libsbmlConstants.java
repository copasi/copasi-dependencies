...
public interface libsbmlConstants {
  public final static String LIBSBML_DOTTED_VERSION = "5.19.0";
  public final static int LIBSBML_VERSION = 51900;
  public final static String LIBSBML_VERSION_STRING = "51900";
  ...
  public final static int LIBSBML_SEV_UNKNOWN = LIBSBML_SEV_NOT_APPLICABLE + 1;
  ...
  public final static int EM_REMAINING = EM_ARRAYS + 1;
  public final static int EM_UNKNOWN = EM_REMAINING + 1;
  ...
  public final static int AST_LINEAR_ALGEBRA_VECTOR = 600;
  ...
  public final static int AST_LOGICAL_EXISTS = 700;
  public final static int AST_LOGICAL_FORALL = AST_LOGICAL_EXISTS + 1;
  public final static int AST_STATISTICS_MEAN = 800;
  ...
  public final static int AST_STATISTICS_SDEV = AST_STATISTICS_MOMENT + 1;
  public final static int AST_STATISTICS_VARIANCE = AST_STATISTICS_SDEV + 1;
  public final static int AST_STATISTICS_MOMENTABOUT = AST_STATISTICS_VARIANCE + 1;
  public final static int AST_SERIES_PRODUCT = 900;
  public final static int AST_SERIES_SUM = AST_SERIES_PRODUCT + 1;
  public final static int AST_SERIES_LIMIT = AST_SERIES_SUM + 1;
  public final static int AST_SERIES_TENDSTO = AST_SERIES_LIMIT + 1;
  public final static int AST_ALGEBRA_GCD = 1000;
  public final static int AST_ALGEBRA_CONJUGATE = AST_ALGEBRA_GCD + 1;
  public final static int AST_ALGEBRA_ARG = AST_ALGEBRA_CONJUGATE + 1;
  public final static int AST_ALGEBRA_REAL = AST_ALGEBRA_ARG + 1;
  public final static int AST_ALGEBRA_IMAGINARY = AST_ALGEBRA_REAL + 1;
  public final static int AST_ALGEBRA_LCM = AST_ALGEBRA_IMAGINARY + 1;
  public final static int AST_RELATIONS_EQUIVALENT = 1100;
  public final static int AST_RELATIONS_APPROX = AST_RELATIONS_EQUIVALENT + 1;
  public final static int AST_RELATIONS_FACTOROF = AST_RELATIONS_APPROX + 1;
  public final static int AST_CALCULUS_INT = 1200;
  public final static int AST_CALCULUS_DIFF = AST_CALCULUS_INT + 1;
  public final static int AST_CALCULUS_PARTIALDIFF = AST_CALCULUS_DIFF + 1;
  public final static int AST_CALCULUS_LOWLIMIT = AST_CALCULUS_PARTIALDIFF + 1;
  public final static int AST_CALCULUS_UPLIMIT = AST_CALCULUS_LOWLIMIT + 1;
  public final static int AST_CALCULUS_DIVERGENCE = AST_CALCULUS_UPLIMIT + 1;
  public final static int AST_CALCULUS_GRAD = AST_CALCULUS_DIVERGENCE + 1;
  public final static int AST_CALCULUS_CURL = AST_CALCULUS_GRAD + 1;
  public final static int AST_CALCULUS_LAPLACIAN = AST_CALCULUS_CURL + 1;
  public final static int AST_SET_THEORY_SET = 1300;
  public final static int AST_SET_THEORY_LIST = AST_SET_THEORY_SET + 1;
  public final static int AST_SET_THEORY_UNION = AST_SET_THEORY_LIST + 1;
  public final static int AST_SET_THEORY_INTERSECT = AST_SET_THEORY_UNION + 1;
  public final static int AST_SET_THEORY_IN = AST_SET_THEORY_INTERSECT + 1;
  public final static int AST_SET_THEORY_NOTIN = AST_SET_THEORY_IN + 1;
  public final static int AST_SET_THEORY_SUBSET = AST_SET_THEORY_NOTIN + 1;
  public final static int AST_SET_THEORY_PRSUBSET = AST_SET_THEORY_SUBSET + 1;
  public final static int AST_SET_THEORY_NOTSUBSET = AST_SET_THEORY_PRSUBSET + 1;
  public final static int AST_SET_THEORY_NOTPRSUBSET = AST_SET_THEORY_NOTSUBSET + 1;
  public final static int AST_SET_THEORY_SETDIFF = AST_SET_THEORY_NOTPRSUBSET + 1;
  public final static int AST_SET_THEORY_CARD = AST_SET_THEORY_SETDIFF + 1;
  public final static int AST_SET_THEORY_CARTESIANPRODUCT = AST_SET_THEORY_CARD + 1;
  public final static int AST_CONSTANT_IMAGINARYI = 1400;
  public final static int AST_CONSTANTS_INTEGERS = AST_CONSTANT_IMAGINARYI + 1;
  public final static int AST_CONSTANTS_REALS = AST_CONSTANTS_INTEGERS + 1;
  public final static int AST_CONSTANTS_RATIONALS = AST_CONSTANTS_REALS + 1;
  public final static int AST_CONSTANTS_NATURALNUMBERS = AST_CONSTANTS_RATIONALS + 1;
  public final static int AST_CONSTANTS_COMPLEXES = AST_CONSTANTS_NATURALNUMBERS + 1;
  public final static int AST_CONSTANTS_PRIMES = AST_CONSTANTS_COMPLEXES + 1;
  public final static int AST_CONSTANTS_EMPTYSET = AST_CONSTANTS_PRIMES + 1;
  public final static int AST_CONSTANTS_EULERGAMMA = AST_CONSTANTS_EMPTYSET + 1;
  public final static int AST_BASIC_CONTENT_INTERVAL = 1500;
  public final static int AST_BASIC_CONTENT_INVERSE = AST_BASIC_CONTENT_INTERVAL + 1;
  public final static int AST_BASIC_CONTENT_CONDITION = AST_BASIC_CONTENT_INVERSE + 1;
  public final static int AST_BASIC_CONTENT_DECLARE = AST_BASIC_CONTENT_CONDITION + 1;
  public final static int AST_BASIC_CONTENT_COMPOSE = AST_BASIC_CONTENT_DECLARE + 1;
  public final static int AST_BASIC_CONTENT_IDENT = AST_BASIC_CONTENT_COMPOSE + 1;
  public final static int AST_BASIC_CONTENT_DOMAIN = AST_BASIC_CONTENT_IDENT + 1;
  public final static int AST_BASIC_CONTENT_CODOMAIN = AST_BASIC_CONTENT_DOMAIN + 1;
  public final static int AST_BASIC_CONTENT_IMAGE = AST_BASIC_CONTENT_CODOMAIN + 1;
  public final static int AST_BASIC_CONTENT_DOMAINOFAPPLICATION = AST_BASIC_CONTENT_IMAGE + 1;
  public final static int AST_UNKNOWN = 9999;
