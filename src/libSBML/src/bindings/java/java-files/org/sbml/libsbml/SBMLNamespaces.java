...
/** * @internal */ public
 void setLevel(long level) {
    libsbmlJNI.SBMLNamespaces_setLevel(swigCPtr, this, level);
  }

  
/** * @internal */ public
 void setVersion(long version) {
    libsbmlJNI.SBMLNamespaces_setVersion(swigCPtr, this, version);
  }

  
/** * @internal */ public
 void setNamespaces(XMLNamespaces xmlns) {
    libsbmlJNI.SBMLNamespaces_setNamespaces(swigCPtr, this, XMLNamespaces.getCPtr(xmlns), xmlns);
  }
