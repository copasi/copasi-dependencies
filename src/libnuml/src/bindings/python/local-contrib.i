 ...
 * @brief   Contributed class that makes using libNUML from python more convenient
 ...
 * This is attached to NMBase and automatically applies for all classes
