...
{
       0,   186,   186,   189,   190,   193,   194,   243,   247,   287,
     331,   371,   415,   425,   443,   515,   556,   562,   573,   614,
     618,   625,   632,   636,   640,   653,   663,   677,   691,   705,
     718,   728,   746,   755,   771,   784,   801,   815,   880,   887,
     988
};
#endif
...
/* Line 1000 of yacc.c  */
#line 1219 "n3_parser.c"
	break;
      case 14: /* "\"URI literal\"" */

/* Line 1000 of yacc.c  */
#line 168 "./n3_parser.y"
	{
...
/* Line 1000 of yacc.c  */
#line 1305 "n3_parser.c"
	break;
      case 29: /* "verb" */

/* Line 1000 of yacc.c  */
#line 174 "./n3_parser.y"
	{
...
/* Line 1455 of yacc.c  */
#line 747 "./n3_parser.y"
    {
#if RAPTOR_DEBUG > 1  
  printf("resource double=%1g\n", (yyvsp[(1) - (1)].floating));
#endif
  (yyval.identifier)=raptor_new_identifier_from_double(((raptor_parser*)rdf_parser)->world, (yyvsp[(1) - (1)].floating));
  if(!(yyval.identifier))
    YYERROR;
}
    break;
...
#line 989 "./n3_parser.y"
  ...
  (yyval.identifier)=raptor_new_identifier_v2(((raptor_parser*)rdf_parser)->world, RAPTOR_IDENTIFIER_TYPE_RESOURCE, raptor_uri_copy_v2(((raptor_parser*)rdf_parser)->world, n3_parser->nil_uri), RAPTOR_URI_SOURCE_URI, NULL, NULL, NULL, NULL);
  if(!(yyval.identifier))
    YYERROR;
}
    break;
